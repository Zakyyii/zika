module.exports = (m, env) => {
   ...
   if (m.isGroup) {
      ...
      if (group) {
         ...
         if (!('automsg' in group)) group.automsg = false
   ...
   if (setting) {
      ...
      if (!('sk_author' in setting)) setting.sk_author = '© YanaMiku'
...
If you find an error or want to upgrade premium plan contact the owner.`
      ...
      if (!('cover' in setting)) setting.cover = 'https://iili.io/JnwO37e.jpg'
...
If you find an error or want to upgrade premium plan contact the owner.`,
         style: 4,
         cover: 'https://iili.io/JnwO37e.jpg',
